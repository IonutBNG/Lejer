...
public class ModifyProductController implements Initializable, Controller {
     ...
     */
    @FXML
    void handleDeletePartFromProduct(ActionEvent event) {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            System.out.println("Canceled product deletion.");
        }
    }
    ...
    void handleSaveProduct(ActionEvent event) throws IOException {
        ...
        try {
            ...
            if(errorMessage.length() > 0) {
                ...
                service.updateProduct(productIndex,  name, Double.parseDouble(price), Integer.parseInt(inStock), Integer.parseInt(min), Integer.parseInt(max), addParts);
                displayScene(event, "/fxml/MainScreen.fxml");
            }
