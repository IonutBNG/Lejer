    ...
    void handleModifyPartSave(ActionEvent event) throws IOException {
        ...
        try {
                if(isOutsourced == true) {
                    service.updateOutsourcedPart(partIndex, name, Double.parseDouble(price), Integer.parseInt(inStock), Integer.parseInt(min), Integer.parseInt(max), partDynamicValue);
                } else {
                    service.updateInhousePart(partIndex,  name, Double.parseDouble(price), Integer.parseInt(inStock), Integer.parseInt(min), Integer.parseInt(max), Integer.parseInt(partDynamicValue));
                }
                displayScene(event, "/fxml/MainScreen.fxml");
            }
